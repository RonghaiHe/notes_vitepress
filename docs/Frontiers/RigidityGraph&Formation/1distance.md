...
If the axis of rotation does not intersect the rigid body, the motion is usually called a **revolution** or **orbit**. This type of motion (in fact, any type of rigid body motion) can be decomposed into a **translation superimposed on a rotation**. That is, the above definitions allow one to **decouple** pure translation from pure rotation. Recall from rigid body kinematics that given body-fixed points $p$ and $O$ (see [Figure 0](#fig-0)), the following relationship holds
...
<figure>
   <img src="./images/1dist_0-motion.png" alt="Motion of rigid body" id="fig-1.0" width="100%" align="center">
...
<span id="thm-laman"></span>

> [!caution] Laman's Theorem
...
<figure>
   <img src="./images/1dist_05-nongeneric.png" id="fig-105-nongeneric" alt="Nongeneric framework"  width="100%" align="center">
...
In the definition of continuous family, i.e. formula [$(4)$](#eq-4), the right-hand side is constant by definition. Assuming the trajectories $p_i(t), i \in \mathcal{V}$ are differentiable on $t \in [0, 1]$, we square both sides of [$(4)$](#eq-4) and differentiate w.r.t. time to obtain
$$
...
Using [$(6)$](#eq-6), we can conveniently rewrite [$(5)$](#eq-5) as
...
Note that if a framework undergoes any rigid body motion, then according to [$(3)$](#eq-3) vertex $i$ has velocity
$$
...
It is not difficult to check that [$(7)$](#eq-7) holds in this case since for the $k$-th row of $R$:
$$
\begin{aligned}
...
<figure>
   <img src="./images/1dist_1-henneberg.png" alt="Henneberg's Method" width="100%" align="center">
...
> [!warning] Definition: globally rigidity
...
<figure>
   <img src="./images/1dist_2-local_rigidity.png" alt="Ambiguity in local rigidity" width="100%" align="center">
...
> [!caution] Theorem 5 (Theorem 4 in arbitary dimension)
...
> 2. Marcio de Queiroz, Xiaoyu Cai, and Matthew Feemster, *[Formation Control of Multi-Agent Systems: A Graph Rigidity Approach](https://onlinelibrary.wiley.com/doi/book/10.1002/9781118887455)*. USA: John Wiley & Sons, Ltd, 2019. Accessed: Dec. 31, 2025: Section 2.
> 3. Bruce Hendrickson, *[Conditions for unique graph realizations](http://epubs.siam.org/doi/10.1137/0221008)*, SIAM J. Comput., vol. 21, no. 1, pp. 65–84, Feb. 1992.
> 4. **Zhiyong Sun**, Changbin Yu, and **B. D. O. Anderson**, *[Distributed estimation and control for preserving formation rigidity for mobile robot teams](https://arxiv.org/abs/1309.4850)*, Sep. 19, 2013. Accessed: Dec. 29, 2025: Preliminaries part.
> 5. **Zhiyong Sun**, M.-C. Park, **B. D. O. Anderson**, and H.-S. Ahn, *[Distributed stabilization control of rigid formations with prescribed orientation](https://arxiv.org/abs/1606.03199)*, Automatica J. IFAC, vol. 78, pp. 250–257, Apr. 2017: Preliminaries part.
> 6. **Gangshan Jing**, G. Zhang, H. W. J. Lee, and L. Wang, *[Angle-based shape determination theory of planar graphs with application to formation stabilization](https://www.sciencedirect.com/science/article/pii/S0005109819301475)*, Automatica J. IFAC, vol. 105, pp. 117–129, Jul. 2019: Preliminaries part.
> 7. L. Asimow and B. Roth, *[The Rigidity of Graphs](https://www.jstor.org/stable/1998867)*, Transactions of the American Mathematical Society, vol. 245, pp. 279–289, 1978.
> 8. Robert Connelly, *[Generic Global Rigidity](http://link.springer.com/10.1007/s00454-004-1124-4)*, Discrete Comput. Geom., vol. 33, no. 4, pp. 549–563, Apr. 2005: Part 1.2.
> 9. **Shiyu Zhao** and **Daniel Zelazo**, *[Bearing rigidity theory and its applications for control and estimation of framework systems: life beyond distance rigidity](https://ieeexplore.ieee.org/abstract/document/8667521)*, IEEE Control Syst. Mag., vol. 39, no. 2, pp. 66–83, Apr. 2019: 1st Part.
